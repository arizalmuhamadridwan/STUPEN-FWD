          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
              ...
              <tbody>
                {authors.length > 0 ? (
                  authors.map((author) => (
                    <tr key={author.name} className="border-b dark:border-gray-700">
                      ...
                      <td className="px-4 py-3 flex items-center justify-end relative">
                        <button
                          id={`dropdown-button-${author.name}`}
                          onClick={() => toggleDropdown(author.name)}
                        ...
                        {openDropdownId === author.name && (
                          ...
                          >
                            <ul
                              ...
                              aria-labelledby={`dropdown-button-${author.name}`}
                            >
                              <li>
                                <Link
                                  to={`/admin/authors/edit/${author.name}`}
