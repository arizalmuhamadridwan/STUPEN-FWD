...
export default function AuthorEdit() {
  ...
  useEffect(() => {
    const fetchAuthor = async () => {
      try {
        ...
        setPreview(authorData.photo ? authorData.photo : null); // ✅ ini sekarang jalan
      } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert("Terjadi kesalahan saat memperbarui data author.");
    }
  };
          ...
          <div className="grid gap-4 mb-4 sm:grid-cols-1 sm:gap-6 sm:mb-5">
            ...
            <div>
              ...
              <input
                ...
                accept="image/*"
                onChange={handleChange}
                className="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400"
              />
              {preview && (
                <img
                  src={preview}
